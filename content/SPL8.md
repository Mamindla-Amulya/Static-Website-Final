...
var firebaseConfig = {
      ...
      firebase.initializeApp(firebaseConfig);
       ...
       const commentsRef = rootRef.child('comments/spl8');
       ...
       var showat = document.getElementById('spl8');
       //Get comments whose from page equals this page's pathname.
       var commentsRef = firebase.database().ref('comments/spl8');
...
function removeData_1(params){
   ...
   // key = document.getElementById('key').value;
    fb.child('comments/spl8'+ params.id +'/').remove()
